...
public class RelativeFrequencyStripes extends Configured implements Tool {
	//private static int distinct_words = 0;
	   ...
	   public int run(String[] args) throws Exception {
	      ...
	      myjob.setJarByClass(RelativeFrequencyStripes.class);
	     ...
	     // myjob.setMapperClass(MapStripes.class); //for stripes approach
	      myjob.setMapperClass(MapStripes.class);
	      ...
	      myjob.setReducerClass(ReduceStripes.class);
		    ...
		    public void map(LongWritable key, Text value, Context context)
		       ...
		       for(int i = 0; i < linewords.size(); i++) {
		    	   ...
		    	   for(int j = 0; j < linewords.size(); j++) {
		    		   if(!linewords.get(j).equals(linewords.get(i))) {
